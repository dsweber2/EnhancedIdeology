...
{
    public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(EnhancedIdeologyDefOf.EB_UnfinishedIdeobook);
    ...
    public override Job? JobOnThing(Pawn pawn, Thing thing, bool forced = false)
    {
        ...
        {
            JobFailReason.Is("EnhancedIdeology.IdeologyMissingRole".Translate(PreceptDefOf.IdeoRole_Moralist.Named("ROLE")));
            return null;
        }
        ...
        {
            JobFailReason.Is("EnhancedIdeology.PawnMissingRequiredRole".Translate(pawn.Named("PAWN"), requiredRole.Label.Named("ROLE")));
            return null;
        }
        ...
        {
            JobFailReason.Is("EnhancedIdeology.BookIsNotForPawnIdeoligion".Translate(pawn.Named("PAWN")));
            return null;
        }
        ...
        {
            JobFailReason.Is("EnhancedIdeology.NoFreeValidLecternFound".Translate());
            return null;
        }

        var job = JobMaker.MakeJob(EnhancedIdeologyDefOf.EB_CompleteReligiousBook, book, foundLectern);
        job.count = 1;
        return job;
    }
}
