...
internal partial class GameComponent_EnhancedIdeology
{
...
#pragma warning restore IDE0028 // Simplify collection initialization
        ...
        public void SetIdeoTracker(Pawn pawn, IdeoTrackerData? data)
        {
            ...
            else
            {
                if (data.Pawn != pawn)
                {
                    EnhancedIdeologyMod.Error($"Tried to set IdeoTrackerData for pawn {pawn} but the data is for pawn {data.Pawn}. This should not happen.");
                    return;
                }
