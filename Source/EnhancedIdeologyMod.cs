...
internal sealed class EnhancedIdeologyMod : Mod
{
#pragma warning disable CS8618 // Set by constructor
    internal static EnhancedIdeologyMod instance;
#pragma warning restore CS8618
    public EnhancedIdeologyMod(ModContentPack content) : base(content)
    {
        instance = this;
    ...
    {
        Log.Message("[Enhanced Ideology] " + msg);
    }
    ...
    public static void DevMessage(string msg)
    {
        if (Prefs.DevMode)
        {
            Log.Message($"[Enhanced Ideology][DEV] " + msg);
        }
    }
    ...
    {
        Log.Warning("[Enhanced Ideology] " + msg);
    }

    public static void WarningOnce(string msg, int key)
    {
        Log.WarningOnce("[Enhanced Ideology] " + msg, key);
    }

    public static void Error(string msg)
    {
        Log.Error("[Enhanced Ideology] " + msg);
    }

    public static void ErrorOnce(string msg, int key)
    {
        Log.ErrorOnce("[Enhanced Ideology] " + msg, key);
    }
