...
public class Settings : ModSettings
{
    ...
    public void DoSettingsWindowContents(Rect inRect)
    {
        ...
        Header(listingStandard, "EnhancedBeliefs.Section.Certainty");
        PercentSlider(listingStandard, "EnhancedBeliefs.CertaintyDriftRate", ref _certaintyDriftRate, 0.02f, 0.5f, DefaultCertaintyDriftRate);
        PercentSlider(listingStandard, "EnhancedBeliefs.DifficultyOffset", ref _difficultyOffset, -0.5f, 0.5f, DefaultDifficultyOffset);
        PercentSlider(listingStandard, "EnhancedBeliefs.RelationalMaxRange", ref _relationalMaxRange, 0f, 0.5f, DefaultRelationalMaxRange);
        PercentSlider(listingStandard, "EnhancedBeliefs.PracticeMaxRange", ref _practiceMaxRange, 0f, 0.5f, DefaultPracticeMaxRange);
        ...
        Header(listingStandard, "EnhancedBeliefs.Section.Opinion");
        PercentSlider(listingStandard, "EnhancedBeliefs.PreceptOppositionScale", ref _preceptOppositionScale, 0f, 1f, DefaultPreceptOppositionScale);

        Header(listingStandard, "EnhancedBeliefs.Section.Debug");
