...
public class CertaintyTests : SeededTest
{
    ...
    public void Drift_RateEqualsDriftRateTimesGap()
    {
        ...
        var expected = EnhancedIdeologyMod.Settings.CertaintyDriftRate * (tracker.CachedTargetCertainty - 0.5f);
    ...
    public void Practice_MaxRange_CapsPractitionalBand()
    {
        ...
        Assert.Equal(EnhancedIdeologyMod.Settings.PracticeMaxRange, tracker.CachedPractitional, precision: 5);
    }
