...
public class ConversionTests : SeededTest
{
    ...
    public void InteractionWorker_WinPull_ScalesWithConversionStancePullSetting()
    {
        ...
        {
            EnhancedIdeologyMod.Settings.ConversionStancePull = setting;
            Rand.SetSeed(1);
    ...
    public void InteractionWorker_WonAttempt_KnocksRecipientCertaintyDown()
    {
        ...
        Assert.Equal(certaintyBefore * EnhancedIdeologyMod.Settings.ConversionCertaintyKnock, recipient.ideo.Certainty, 3);
    }
    ...
    public void Conversion_OvershootsPastOpinionOfNewFaith_AndKeepsHeterodoxStance()
    {
        ...
        EnhancedIdeologyMod.Settings.CrisisThreshold = 0f; // drop the crisis pseudo-candidate so the draw is deterministic
        Rand.SetSeed(1);
        var world = new SimWorld();
        world.Initialize();
